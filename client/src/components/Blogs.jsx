...
const breadcrumbText = "Our Blogs".split("");
...
const Blogs = () => {
  ...
  }, [search, activeCategory, blogPosts]);
      ...
      <main className="flex-grow">
        ...
        <section className="py-8 px-4 text-center bg-white">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
            Stay updated with the latest insights, trends, and innovations in IT, proptech, business strategy, and digital transformation.
          </p>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-10 items-center justify-between">
              <div className="relative w-full md:w-80">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-3 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0076d8] bg-white shadow-sm"
                  type="text"
                  value={search}
            ...
            {loading && (
              <div className="flex justify-center items-center py-20">
                <div className="w-10 h-10 border-4 border-[#0076d8] border-t-transparent rounded-full animate-spin"></div>
              </div>
            )}

            {/* Error state */}
            {!loading && error && (
              <div className="bg-red-50 border border-red-100 rounded-2xl py-12 px-6 text-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                {filteredPosts.map((post, index) => (
                  <Link
                    key={post.id}
                    to={`/blogs/${post.id}`}
                    className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100 hover:-translate-y-1 block no-underline"
                  ...
                  >
                    <div className="relative h-56 overflow-hidden">
                      <img
                        ...
                        src={post.image_url || "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&q=80"}
                      />
                      <span className="absolute top-3 left-3 bg-[#0076d8] text-white text-[10px] font-semibold px-3 py-1 rounded-full">
                        {post.category}
                      </span>
                    </div>
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                        <span className="text-[#0076d8] text-sm font-semibold group-hover:underline">
                          Read More →
                        </span>
